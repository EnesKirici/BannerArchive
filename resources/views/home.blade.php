...
<div class="min-h-screen bg-neutral-950 text-white flex flex-col md:flex-row font-sans overflow-hidden" data-sidebar-collapsed="{{ $sidebarCollapsed ? 'true' : 'false' }}">
    ...
    <div class="md:hidden flex items-center justify-between p-4 border-b border-white/5 bg-neutral-900/95 backdrop-blur-md sticky top-0 z-40">
        ...
        <div class="flex items-center gap-1">
            <a href="{{ route('tools.image-converter') }}" aria-label="Resim Dönüştürücü" class="p-2 rounded-lg text-fuchsia-400 hover:bg-fuchsia-600/10 transition-colors">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
            </a>
            <a href="{{ route('tools.video-downloader') }}" aria-label="Video İndirici" class="p-2 rounded-lg text-cyan-400 hover:bg-cyan-600/10 transition-colors">
    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 w-80 bg-neutral-900 border-r border-white/5 transform -translate-x-full md:relative md:translate-x-0 transition-all duration-300 z-50 flex flex-col h-[calc(100vh-65px)] md:h-screen">
        ...
        <!-- Araçlar -->
        <div class="p-4 border-t border-white/5 shrink-0 bg-neutral-900">
            <h3 class="pb-2.5 text-[10px] uppercase tracking-[0.2em] text-cyan-500 font-bold flex items-center gap-2">
            ...
            <div class="grid grid-cols-2 gap-2">
                <a href="{{ route('tools.image-converter') }}" class="group flex items-center justify-center gap-1.5 px-2 py-2.5 rounded-lg bg-fuchsia-600/10 border border-fuchsia-500/20 hover:bg-fuchsia-600 hover:border-fuchsia-500 text-fuchsia-300 hover:text-white text-xs font-semibold transition-all duration-300">
                    <svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                    </svg>
                    Resim Dönüştür
                </a>
                <a href="{{ route('tools.video-downloader') }}" class="group flex items-center justify-center gap-1.5 px-2 py-2.5 rounded-lg bg-cyan-600/10 border border-cyan-500/20 hover:bg-cyan-600 hover:border-cyan-500 text-cyan-300 hover:text-white text-xs font-semibold transition-all duration-300">
                    <svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
